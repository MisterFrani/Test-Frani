...
4. After installing Node.js, open a terminal and run `npm install` in the main `contact-tool/` folder to download all project dependencies. You'll find them in the `node_modules/` folder.
